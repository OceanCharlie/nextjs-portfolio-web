...
export default function TechConnectCareerPage() {
    return (
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 mb-16 items-center">
                        <div>
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">TechConnect Career</h1>
                            <p className="text-lg text-neutral-400 leading-relaxed max-w-xl">
                                Teaser video production for the official launch of the TechConnect Career website. Start your journey with TechConnect.
                            </p>
                        </div>
                        <div className="relative aspect-video rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-cyan-500/5">
                            <ImageWithFallback
                                src="/images/hire.png"
                                alt="TechConnect Career"
                        ...
                        <div className="lg:col-span-8 space-y-12">
                            <section className="space-y-6">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h2 className="text-2xl font-bold text-white">Video Teaser</h2>
                                </div>
                                <div className="w-full">
                                    <YoutubeEmbed videoId="SIE0WWdsCu4" title="TechConnect Career Launch Teaser" />
                                </div>
                            </section>
                        </div>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            ...
                                            <span className="text-xs px-2 py-1 bg-white/5 rounded border border-white/10">Adobe After Effects</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-8 pt-6 border-t border-white/10">
                                    <Button asChild className="w-full bg-gradient-to-r from-red-600 to-red-800 text-white hover:opacity-90 border-0">
                                        <a href="https://www.youtube.com/watch?v=SIE0WWdsCu4" target="_blank" rel="noopener noreferrer">
